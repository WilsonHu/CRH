  ...
  <div>
    ...
    <el-dialog title="增加故障维护" v-model="addDialogVisible" size="tiny">
      <el-form :model="form">
        <el-form-item label="故障维护：" :label-width="formLabelWidth">
          <el-input v-model="form.maintain_content" auto-complete="off"></el-input>
        </el-form-item>
    ...
    <el-dialog title="编辑故障维护" v-model="modifyDialogVisible" size="tiny">
      <el-form :model="modifyForm">
        <el-form-item label="故障维护：" :label-width="formLabelWidth">
          <el-input v-model="modifyForm.maintain_content" auto-complete="off"></el-input>
        </el-form-item>
        <el-form-item label="部门：" :label-width="formLabelWidth">
