<template xmlns:v-on="http://www.w3.org/1999/xhtml" xmlns:v-bind="http://www.w3.org/1999/xhtml">
  <div>
    ...
    <el-dialog title="增加股道" v-model="addDialogVisible" size="tiny">
      <el-form :model="form">
        <el-form-item label="股道编号：" :label-width="formLabelWidth">
          <el-input v-model="form.gudao_num" auto-complete="off"></el-input>
        </el-form-item>
    ...
    <el-dialog title="编辑股道" v-model="modifyDialogVisible" size="tiny">
      <el-form :model="modifyForm">
        <el-form-item label="股道编号：" :label-width="formLabelWidth">
          <el-input v-model="modifyForm.gudao_num" auto-complete="off"></el-input>
        </el-form-item>
        <el-form-item label="部门：" :label-width="formLabelWidth">
